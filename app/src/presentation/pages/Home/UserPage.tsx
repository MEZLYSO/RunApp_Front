    ...
    <div className="min-h-screen bg-gray-100 p-6 flex flex-col items-center">
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 mt-6 w-full max-w-md">
        ...
        <div className="flex flex-col space-y-3 mt-6">
          ...
          <button className="w-full bg-gray-300 hover:bg-gray-400 text-gray-800 py-2 rounded-md font-medium">
            Borrar cuenta
          </button>
          <button className="w-full bg-red-600 hover:bg-red-700 text-white py-2 rounded-md font-medium">
            Cerrar sesión
          </button>
        </div>
      </div>
